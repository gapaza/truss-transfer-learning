...
from problem.knapsack.TwoObjectiveSimpleKPC import TwoObjectiveSimpleKPC as Problem




class GA_Knapsack_TaskC:
    ...
    def prune_population(self):
        ...
        if len(new_population) > self.pop_size:
            new_population = sorted(new_population, key=lambda x: x.crowding_dist, reverse=True)
