...
from problem.knapsack.ManyObjectiveSimpleKP import ManyObjectiveSimpleKP as Problem




class GA_KnapsackMO_Task:
    ...
    def __init__(
        ...
        # HV
        self.ref_point = np.array(config.hv_ref_point_mo)  # value_1, value_2, weight
