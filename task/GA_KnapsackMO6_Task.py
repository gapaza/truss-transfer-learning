...
from problem.knapsack.ManyObjective6KP import ManyObjective6KP as Problem




class GA_KnapsackMO6_Task:
    ...
    def __init__(
        ...
        # HV
        self.ref_point = np.array(config.hv_ref_point_mo6)  # value_1, value_2, weight
