...
class KnapsackDesignMO4:
    ...
    def __init__(self, design_vector=None, evaluator=None, num_bits=30, c_type='uniform', p_num=0, val=False, constraints=False):
        ...
        if not design_vector:
            self.vector = KnapsackDesignMO4.random_design(num_bits)
    ...
    def set_evaluate(self, results):
        value_1, value_2, value_3, weight = results
        ...
        weight = float(weight)
        self.objectives = [value_1, value_2, value_3, weight]
        self.evaluated = True
