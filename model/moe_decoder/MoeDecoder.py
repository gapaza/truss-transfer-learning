...
@keras.saving.register_keras_serializable(package="MoeDecoder", name="MoeDecoder")
class MoeDecoder(keras.layers.Layer):
    def __init__(
            self,
            intermediate_dim,
            num_heads,
    ...
    def build(
        ...
        self._feedforward_moe = MoeLayer(
            embed_dim=hidden_dim,
            intermediate_dim=self.intermediate_dim,
            num_experts=self.num_experts,
            num_experts_per_token=self.num_experts_per_token,
            name="feedforward_moe",
        )
