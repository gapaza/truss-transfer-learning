...
# Val Task: 0.3800000000000001 0.11392405063291136  # RESULTS
# Val Task: 0.5800000000000003 0.24050632911392403
# Val Task: 0.7800000000000005 0.3670886075949367
# Val Task: 0.9800000000000006 0.4936708860759494
# Val Task: 1.1800000000000008 0.620253164556962  # RESULTS
# Val Task: 1.380000000000001 0.7468354430379747
# Val Task: 1.5800000000000012 0.8734177215189873
# Val Task: 1.7800000000000014 1.0  # RESULTS
time.sleep(1)
...
# Training Parameters
task_epochs = 500  # ----------------- EPOCHS
clip_ratio = 0.2
target_kl = 0.005  # was 0.0001
entropy_coef = 0.02  # ----------------- ENTROPY
...
constraint_term_weight = 0.1  # was 0.2
...
if __name__ == '__main__':
    ...
    # Custom weights
    actor_save_path = os.path.join(config.root_dir, 'taskC', 'studies', 'val3', 'pretrained', 'actor_weights_1000')
    critic_save_path = os.path.join(config.root_dir, 'taskC', 'studies', 'val3', 'pretrained', 'critic_weights_1000')
