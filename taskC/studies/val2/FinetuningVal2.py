...
class PPO_Constrained_MultiTaskValidation(AbstractTask):
    ...
    def build(self):
        ...
        if freeze_actor_base is True:
            ...
            self.c_actor.decoder_3.trainable = False
    ...
    def calc_reward(self, bitstr, weight, task, run_val=True):
        ...
        if in_stiffness_window is False:
            ...
            if stiffness_ratio_term > 20.0:
                stiffness_ratio_term = 20.0
...
if __name__ == '__main__':
    ...
    # Custom weights
    actor_save_path = os.path.join(config.root_dir, 'taskC', 'studies', 'val1', 'pretrained', 'actor_weights_600')
    critic_save_path = os.path.join(config.root_dir, 'taskC', 'studies', 'val1', 'pretrained', 'critic_weights_600')
    ...
    # actor_save_path = os.path.join(config.results_save_dir, 'run_' + str(run_dir), 'pretrained', 'actor_weights_600')
    # critic_save_path = os.path.join(config.results_save_dir, 'run_' + str(run_dir), 'pretrained', 'critic_weights_600')
